...
void ArducamSSD1306::begin(uint8_t vccstate, uint8_t i2caddr, bool reset) {
  _vccstate = vccstate;
  _i2caddr = i2caddr;
...
void ArducamSSD1306::ssd1306_command(uint8_t c) {
...
void ArducamSSD1306::ssd1306_data(uint8_t c) {
